...
\begin{abstract}
CEA working notes formerly in this sample file (research questions, screening criteria,
Boolean strings, LLM/dataset lists, and related CEA remarks) have been moved to
\texttt{cea\_multimodal\_outline.tex}.
\end{abstract}
