...
% Outline skeleton for multimodal CEA lit-review matrix synthesis (include-only).
...
\begin{table}[!t]
\caption{Count of Included Papers by Modality (skeleton)}
...
\begin{table}[!t]
\caption{Count of Included Papers by CEA Setting (skeleton)}
...
\begin{table}[!t]
\caption{Count of Included Papers by Outcome (skeleton)}
...
\begin{table}[!t]
\caption{Count of Included Papers by Method Family (skeleton)}
...
\begin{table}[!t]
\caption{Count of Included Papers by Evidence Type (skeleton)}
...
\begin{table}[!t]
\caption{Count of Included Papers by Contribution Type (skeleton)}
